...
styles =  [(0,(1,5)),(0,(1,1)),(0,(1,1)),(0,(5,10)),(0,(5,5)),(0,(5,1)),(0,(3,10,1,10)),(0, (3, 5, 1, 5)),(0,(3,1,1,1)),(0,(3,5,1,5,1,5)),(0,(3,10,1,10,1,10)),(0,(3,1,1,1,1,1))]  
...
for i in range(nzones-1):
    ...
    if ((i%15) == 0 and i != 0):
        number = int(i/15-1)
        ax1.plot(nu_cyclosyn,lnu_cyclosyn*fluxconv,linewidth=2.0,color=colors[i],zorder=nzones-i,linestyle=styles[number])#,linestyle='dashed')
        ax1.plot(nu_compton,lnu_compton*fluxconv,linewidth=2.0,color=colors[i],zorder=nzones-i,linestyle=styles[number])#,linestyle='dashed')
...
ax1.plot(Total.T[0]/kevconv,Total.T[1]*Total.T[0]*mjy*fluxconv,linewidth=2.5,color='black',zorder=nzones+1)
