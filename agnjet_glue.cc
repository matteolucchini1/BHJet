...
static int allocate_agnjet_opaque_types(void) /* {{{ */
{
...
static void sl_update_ebreak (void)
{
   int arg1;
   int arg2;
   double arg3;
   ...
   if (SLang_Num_Function_Args != 10) goto usage_label;
   ...
   update_ebreak( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_lost_ele (void)
{
   ...
   lost_ele( arg1,  arg2, arg3, arg4,  arg5,  arg6, arg7, arg8, arg9, arg10);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (2, 2, 0);
   finalize_refs(6,arg3_r,arg4_r,arg7_r,arg8_r,arg9_r,arg10_r); 
}

static void sl_spcomponents (void)
{
   int arg1;
   int arg2;
   int arg3;
   ...
   double* arg12;
   Slirp_Ref *arg12_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg12,0x0);
   double* arg13;
   Slirp_Ref *arg13_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg13,0x0);
   double* arg14;
   Slirp_Ref *arg14_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg14,0x0);
   double* arg15;
   Slirp_Ref *arg15_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg15,0x0);
   double* arg16;
   Slirp_Ref *arg16_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg16,0x0);
   double* arg17;
   Slirp_Ref *arg17_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg17,0x0);
   double* arg18;
   Slirp_Ref *arg18_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg18,0x0);
   double* arg19;
   Slirp_Ref *arg19_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg19,0x0);
   double* arg20;
   Slirp_Ref *arg20_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg20,0x0);
   double* arg21;
   Slirp_Ref *arg21_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg21,0x0);
   int issue_usage = 1;

   if (SLang_Num_Function_Args != 21) goto usage_label;
   if (-1 == pop_array_or_ref( arg21_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg20_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg19_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg18_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg17_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg16_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg15_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg14_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg13_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg12_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg11_r, 0x0, 0)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg9)) goto usage_label;
   if (-1 == pop_array_or_ref( arg8_r, 0x0, 0)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg7)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg6)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg5)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg4)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg3)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg2)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg1)) goto usage_label;
   issue_usage = 0;

   spcomponents( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7, arg8,  arg9,  arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (3, 3, 0);
   finalize_refs(12,arg8_r,arg11_r,arg12_r,arg13_r,arg14_r,arg15_r,arg16_r,arg17_r,arg18_r,arg19_r,arg20_r,arg21_r); 
}

static void sl_f_int2 (void)
{
   double retval;
   double arg1;
   void* arg2;
...
static void sl_bhinterp (void)
{
   ...
   bhinterp(arg1, arg2, arg3, arg4,  arg5,  arg6);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_pa_rate_thermal (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   pa_rate_thermal( arg1,  arg2,  arg3);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_norm_at_shock (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   Slirp_Ref *arg21_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg21,0x0);
   double* arg22;
   Slirp_Ref *arg22_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg22,0x0);
   double arg23;
   int issue_usage = 1;

   if (SLang_Num_Function_Args != 23) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg23)) goto usage_label;
   if (-1 == pop_array_or_ref( arg22_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg21_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg20_r, 0x0, 0)) goto usage_label;
   ...
   if (-1 == pop_array_or_ref( arg13_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg12_r, 0x0, 0)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg11)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg9)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg8)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg7)) goto usage_label;
   ...
   norm_at_shock( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18,  arg19, arg20, arg21, arg22,  arg23);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (8, 8, 0);
   finalize_refs(10,arg12_r,arg13_r,arg14_r,arg15_r,arg16_r,arg17_r,arg18_r,arg20_r,arg21_r,arg22_r); 
}
...
static void sl_particles_init (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   if (SLang_Num_Function_Args != 26) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg26)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg25)) goto usage_label;
   ...
   particles_init( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15,  arg16,  arg17,  arg18,  arg19,  arg20,  arg21,  arg22,  arg23,  arg24,  arg25,  arg26);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_bbdisk_comp (void)
{
   int arg1;
   int arg2;
   double arg3;
   ...
   bbdisk_comp( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_average_ene (void)
{
   double retval;
   int arg1;
   int arg2;
   ...
   retval = average_ene( arg1,  arg2, arg3, arg4, arg5);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   ...
   finalize_refs(3,arg3_r,arg4_r,arg5_r); 
}

static void sl_mcdjet1 (void)
{
   double retval;
   double arg1;
   double arg2;
   ...
   retval = mcdjet1( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
...
static void sl_mcd_obs (void)
{
   ...
   retval = mcd_obs( arg1,  arg2,  arg3,  arg4,  arg5);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
...
static void sl_MICompton (void)
{
   ...
   gsl_interp_accel* arg14;
   Slirp_Opaque* arg14_o = NULL;
   gsl_spline* arg15;
   Slirp_Opaque* arg15_o = NULL;
   gsl_interp_accel* arg16;
   Slirp_Opaque* arg16_o = NULL;
   double arg17;
   double arg18;
   double arg19;
   double arg20;
   ...
   Slirp_Ref *arg22_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg22,0x0);
   double* arg23;
   Slirp_Ref *arg23_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg23,0x0);
   double* arg24;
   Slirp_Ref *arg24_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg24,0x0);
   double* arg25;
   Slirp_Ref *arg25_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg25,0x0);
   int issue_usage = 1;

   if (SLang_Num_Function_Args != 25) goto usage_label;
   if (-1 == pop_array_or_ref( arg25_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg24_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg23_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg22_r, 0x0, 0)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg21)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg20)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg19)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg18)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg17)) goto usage_label;
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg16, &arg16_o)) goto usage_label;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg15, &arg15_o)) goto free_and_return_16;
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg14, &arg14_o)) goto free_and_return_15;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg13, &arg13_o)) goto free_and_return_14;
   if (-1 == pop_array_or_ref( arg12_r, 0x0, 0)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg11)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg10)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg9)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg8)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg7)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg6)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg5)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg4)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg3)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg2)) goto free_and_return_13;
   if (-1 == SLang_pop_char((char*)&arg1)) goto free_and_return_13;
   issue_usage = 0;

   MICompton( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11, arg12, arg13, arg14, arg15, arg16,  arg17,  arg18,  arg19,  arg20,  arg21, arg22, arg23, arg24, arg25);
   goto free_and_return;
free_and_return:
   /* drop */
free_and_return_13:
...
free_and_return_14:
   SLang_free_opaque(arg14_o);
free_and_return_15:
   SLang_free_opaque(arg15_o);
free_and_return_16:
   SLang_free_opaque(arg16_o);
usage_label:
   if (issue_usage) Slirp_usage (16, 16, 0);
   finalize_refs(5,arg12_r,arg22_r,arg23_r,arg24_r,arg25_r); 
}
...
static void sl_jetpars (void)
{
   ...
   if (SLang_Num_Function_Args != 18) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg18)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg17)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg16)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg15)) goto usage_label;
   ...
   jetpars( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11, arg12, arg13,  arg14,  arg15,  arg16,  arg17,  arg18);
   goto free_and_return;
free_and_return:
   /* drop */
free_and_return_12:
...
static void sl_pl_and_th_comp (void)
{
   bool arg1;
   double arg2;
   int arg3;
   ...
   if (-1 == SLang_pop_int((int*)&arg3)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg2)) goto usage_label;
   if (-1 == SLang_pop_char((char*)&arg1)) goto usage_label;
   issue_usage = 0;

   pl_and_th_comp( arg1,  arg2,  arg3,  arg4,  arg5, arg6, arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15,  arg16,  arg17,  arg18,  arg19, arg20, arg21, arg22, arg23,  arg24);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (22, 22, 0);
   finalize_refs(6,arg6_r,arg7_r,arg20_r,arg21_r,arg22_r,arg23_r); 
}

static void sl_star (void)
{
   double retval;
   double arg1;
   double arg2;
   ...
   retval = star( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
...
static void sl_disk_init (void)
{
   ...
   if (SLang_Num_Function_Args != 15) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg15)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg14)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg13)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg12)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg11)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg9)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg8)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg7)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg6)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg5)) goto usage_label;
   ...
   disk_init( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
...
static void sl_seed_sync_and_disk_phtns (void)
{
   bool arg1;
   int arg2;
   int arg3;
   ...
   if (SLang_Num_Function_Args != 22) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg22)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg21)) goto usage_label;
   if (-1 == pop_array_or_ref( arg20_r, 0x0, 0)) goto usage_label;
   if (-1 == pop_array_or_ref( arg19_r, 0x0, 0)) goto usage_label;
   ...
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg9)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg8)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg7)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg6)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg5)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg4)) goto usage_label;
   ...
   seed_sync_and_disk_phtns( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14, arg15, arg16, arg17, arg18, arg19, arg20,  arg21,  arg22);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (25, 25, 0);
   finalize_refs(6,arg15_r,arg16_r,arg17_r,arg18_r,arg19_r,arg20_r); 
}

static void sl_maxene (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   maxene( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (26, 26, 0);
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (27, 27, 0);
}

static void sl_annihilation (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   annihilation( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (28, 28, 0);
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (29, 29, 0);
}

static void sl_ene_arrays (void)
{
   bool arg1;
   int arg2;
   int arg3;
   ...
   ene_arrays( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (30, 30, 0);
   finalize_refs(7,arg15_r,arg16_r,arg17_r,arg18_r,arg19_r,arg20_r,arg21_r); 
}

static void sl_mcd_jet (void)
{
   double retval;
   double arg1;
   double arg2;
   ...
   retval = mcd_jet( arg1,  arg2,  arg3,  arg4,  arg5);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (31, 31, 0);
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (32, 32, 0);
}

static void sl_vel_prof (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg9)) goto usage_label;
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg8, &arg8_o)) goto usage_label;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg7, &arg7_o)) goto free_and_return_8;
   if (-1 == SLang_pop_double((double*)&arg6)) goto free_and_return_7;
   if (-1 == SLang_pop_double((double*)&arg5)) goto free_and_return_7;
   if (-1 == SLang_pop_double((double*)&arg4)) goto free_and_return_7;
   if (-1 == SLang_pop_double((double*)&arg3)) goto free_and_return_7;
   if (-1 == SLang_pop_double((double*)&arg2)) goto free_and_return_7;
   if (-1 == SLang_pop_double((double*)&arg1)) goto free_and_return_7;
   issue_usage = 0;

   vel_prof( arg1,  arg2,  arg3,  arg4,  arg5,  arg6, arg7, arg8,  arg9,  arg10);
   goto free_and_return;
free_and_return:
   /* drop */
free_and_return_7:
...
usage_label:
   if (issue_usage) Slirp_usage (33, 33, 0);
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (34, 34, 0);
}

static void sl_integrate2 (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   integrate2( arg1,  arg2,  arg3, arg4, arg5);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (35, 35, 0);
   finalize_refs(2,arg4_r,arg5_r); 
}

static void sl_zonepars (void)
{
   int arg1;
   int arg2;
   int arg3;
   ...
   if (-1 == SLang_pop_double((double*)&arg16)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg15)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg14)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg13)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg12)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg11)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg10)) goto usage_label;
   ...
   zonepars( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15,  arg16,  arg17,  arg18,  arg19,  arg20,  arg21,  arg22, arg23);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (36, 36, 0);
   finalize_refs(1,arg23_r); 
}

static void sl_mcdobs1 (void)
{
   double retval;
   double arg1;
   double arg2;
   ...
   retval = mcdobs1( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (37, 37, 0);
}

static void sl_jetgrid (void)
{
   int arg1;
   int arg2;
   int arg3;
   ...
   if (SLang_Num_Function_Args != 14) goto usage_label;
   if (-1 == pop_array_or_ref( arg14_r, 0x0, 0)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg13)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg12)) goto usage_label;
   if (-1 == SLang_pop_int((int*)&arg11)) goto usage_label;
   ...
   jetgrid( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13, arg14);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (38, 38, 0);
   finalize_refs(1,arg14_r); 
}

static void sl_f_int (void)
{
   double retval;
   double arg1;
   void* arg2;
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (39, 39, 0);
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (40, 40, 0);
}

static void sl_create_plotFiles (void)
{
   int arg1;
   int arg2;
   int issue_usage = 1;
   ...
   create_plotFiles( arg1,  arg2);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (41, 41, 0);
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (42, 42, 0);
}

static void sl_integrate (void)
{
   double arg1;
   double arg2;
   double arg3;
   ...
   integrate( arg1,  arg2,  arg3, arg4, arg5);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (43, 43, 0);
   finalize_refs(2,arg4_r,arg5_r); 
}
...
usage_label:
   if (issue_usage) Slirp_usage (44, 44, 0);
}

static void sl_fjet11 (void)
{
   double retval;
   double arg1;
   void* arg2;
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (45, 45, 0);
}

static void sl_fjet1 (void)
{
   double retval;
   double arg1;
   void* arg2;
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (46, 46, 0);
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (47, 47, 0);
}

static void sl_write_plotFiles (void)
{
   int arg1;
   int arg2;
   int arg3;
   ...
   if (SLang_Num_Function_Args != 16) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg16)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg15)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg14)) goto usage_label;
   if (-1 == SLang_pop_double((double*)&arg13)) goto usage_label;
   ...
   write_plotFiles( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15,  arg16);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (48, 48, 0);
}

static void sl_pproduction (void)
{
   int arg1;
   double arg2;
   double* arg3;
   ...
   pproduction( arg1,  arg2, arg3, arg4,  arg5,  arg6);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (49, 49, 0);
   finalize_refs(2,arg3_r,arg4_r); 
}

static void sl_jet_init (void)
{
   int arg1;
   int arg2;
   double arg3;
   ...
   jet_init( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14,  arg15,  arg16,  arg17,  arg18,  arg19,  arg20,  arg21, arg22, arg23, arg24, arg25);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (50, 50, 0);
   finalize_refs(4,arg22_r,arg23_r,arg24_r,arg25_r); 
}

static void sl_enden_dd (void)
{
   double retval;
   double arg1;
   double arg2;
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (51, 53, 0);
}

static void sl_enden (void) { dispatch(0, 2, 51, 0); }

static void sl_read_and_shift_eldists (void)
{
   int arg1;
   int arg2;
   double arg3;
   ...
   read_and_shift_eldists( arg1,  arg2,  arg3,  arg4,  arg5, arg6, arg7, arg8, arg9, arg10, arg11);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (52, 52, 0);
   finalize_refs(6,arg6_r,arg7_r,arg8_r,arg9_r,arg10_r,arg11_r); 
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (53, 53, 0);
}

static void sl_elnorm (void)
{
   int arg1;
   double arg2;
   double arg3;
   ...
   elnorm( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (54, 54, 0);
}

static void sl_mj (void)
{
   double retval;
   double arg1;
   double arg2;
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (55, 55, 0);
}

static void sl_synchrotron (void)
{
   bool arg1;
   int arg2;
   int arg3;
   ...
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg18, &arg18_o)) goto usage_label;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg17, &arg17_o)) goto free_and_return_18;
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg16, &arg16_o)) goto free_and_return_17;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg15, &arg15_o)) goto free_and_return_16;
   if (-1 == SLang_pop_opaque(gsl_interp_accel_ptr_Type, (void**)&arg14, &arg14_o)) goto free_and_return_15;
   if (-1 == SLang_pop_opaque(gsl_spline_ptr_Type, (void**)&arg13, &arg13_o)) goto free_and_return_14;
   if (-1 == SLang_pop_double((double*)&arg12)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg11)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg10)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg9)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg8)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg7)) goto free_and_return_13;
   if (-1 == SLang_pop_double((double*)&arg6)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg5)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg4)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg3)) goto free_and_return_13;
   if (-1 == SLang_pop_int((int*)&arg2)) goto free_and_return_13;
   ...
   synchrotron( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23);
   goto free_and_return;
free_and_return:
   /* drop */
free_and_return_13:
...
free_and_return_18:
   SLang_free_opaque(arg18_o);
usage_label:
   if (issue_usage) Slirp_usage (56, 56, 0);
   finalize_refs(5,arg19_r,arg20_r,arg21_r,arg22_r,arg23_r); 
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (57, 57, 0);
}

static void sl_electrons (void)
{
   int arg1;
   int arg2;
   double arg3;
   ...
   electrons( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10, arg11, arg12, arg13, arg14,  arg15);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (58, 58, 0);
   finalize_refs(4,arg11_r,arg12_r,arg13_r,arg14_r); 
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (59, 59, 0);
}
...
static void sl_equipartition (void)
{
   ...
   equipartition( arg1,  arg2,  arg3,  arg4,  arg5,  arg6,  arg7,  arg8,  arg9,  arg10,  arg11,  arg12,  arg13,  arg14);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (60, 60, 0);
}

static void sl_bb (void)
{
   double retval;
   double arg1;
   double arg2;
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (61, 61, 0);
}
...
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (62, 62, 0);
}
...
free_and_return_2:
   SLang_free_opaque(arg2_o);
usage_label:
   if (issue_usage) Slirp_usage (63, 63, 0);
}

static void sl_mjed (void)
{
   double retval;
   double arg1;
   double arg2;
   ...
   retval = mjed( arg1,  arg2);
   (void)SLang_push_double(retval);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (64, 64, 0);
}

static void sl_bhjet (void)
{
   double* arg1;
   Slirp_Ref *arg1_r = ref_new(SLANG_DOUBLE_TYPE,sizeof(double),&arg1,0x0);
   int arg2;
   ...
   bhjet(arg1,  arg2, arg3, arg4, arg5);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (65, 65, 0);
...
usage_label:
   if (issue_usage) Slirp_usage (66, 66, 0);
}

static void sl_ucompton (void)
{
   int arg1;
   int arg2;
   int arg3;
   ...
   ucompton( arg1,  arg2,  arg3,  arg4,  arg5,  arg6, arg7, arg8, arg9,  arg10);
   goto free_and_return;
free_and_return:
   /* drop */
usage_label:
   if (issue_usage) Slirp_usage (67, 67, 0);
   finalize_refs(3,arg7_r,arg8_r,arg9_r); 
}
...
usage_label:
   if (issue_usage) Slirp_usage (68, 68, 0);
}


static SLang_Intrin_Fun_Type agnjet_Funcs [] =
{
   MAKE_INTRINSIC_0((char*)"k3_fnc",sl_k3_fnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"update_ebreak",sl_update_ebreak,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"lost_ele",sl_lost_ele,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"spcomponents",sl_spcomponents,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"f_int2",sl_f_int2,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bhinterp",sl_bhinterp,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"pa_rate_thermal",sl_pa_rate_thermal,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"k2_fnc",sl_k2_fnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"norm_at_shock",sl_norm_at_shock,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbintegrals",sl_bbintegrals,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"particles_init",sl_particles_init,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbdisk_comp",sl_bbdisk_comp,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"average_ene",sl_average_ene,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mcdjet1",sl_mcdjet1,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"b_prof",sl_b_prof,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mcd_obs",sl_mcd_obs,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"MICompton",sl_MICompton,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"jetpars",sl_jetpars,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"aven",sl_aven,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"absfnc",sl_absfnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"comint",sl_comint,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"pa_rate",sl_pa_rate,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"pl_and_th_comp",sl_pl_and_th_comp,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"star",sl_star,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"disk_init",sl_disk_init,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"seed_sync_and_disk_phtns",sl_seed_sync_and_disk_phtns,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"maxene",sl_maxene,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbearth",sl_bbearth,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"annihilation",sl_annihilation,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbfnc",sl_bbfnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"ene_arrays",sl_ene_arrays,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mcd_jet",sl_mcd_jet,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbdisk",sl_bbdisk,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"vel_prof",sl_vel_prof,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"synint",sl_synint,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"integrate2",sl_integrate2,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"zonepars",sl_zonepars,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mcdobs1",sl_mcdobs1,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"jetgrid",sl_jetgrid,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"f_int",sl_f_int,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbfnc3",sl_bbfnc3,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"create_plotFiles",sl_create_plotFiles,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"k0_fnc",sl_k0_fnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"integrate",sl_integrate,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bljetpars",sl_bljetpars,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"fjet11",sl_fjet11,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"fjet1",sl_fjet1,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"K2",sl_K2,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"write_plotFiles",sl_write_plotFiles,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"pproduction",sl_pproduction,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"jet_init",sl_jet_init,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"enden",sl_enden,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"read_and_shift_eldists",sl_read_and_shift_eldists,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbdiskfnc",sl_bbdiskfnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"elnorm",sl_elnorm,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mj",sl_mj,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"synchrotron",sl_synchrotron,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"k1_fnc",sl_k1_fnc,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"electrons",sl_electrons,SLANG_VOID_TYPE),
   ...
   MAKE_INTRINSIC_0((char*)"bb",sl_bb,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bbearthint",sl_bbearthint,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"synemis",sl_synemis,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"mjed",sl_mjed,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"bhjet",sl_bhjet,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"comintegral",sl_comintegral,SLANG_VOID_TYPE),
   MAKE_INTRINSIC_0((char*)"ucompton",sl_ucompton,SLANG_VOID_TYPE),
...
static const char* usage_strings[] = { /* {{{ */
   ...
   "update_ebreak(int,int,double,double,double,double,double,double,double,double)",
   "lost_ele(int,int,double[],double[],double,double,double[],double[],double[],double[])",
   "spcomponents(int,int,int,int,int,int,int,double[],double,double,double[],double[],double[],double[],double[],double[],double[],double[],double[],double[],double[])",
   "double = f_int2(double,void_ptr)",
   "bhinterp(double[],double[],double[],double[],int,int)",
   "pa_rate_thermal(double,double,double)",
   "double = k2_fnc(double)",
   "norm_at_shock(double,double,double,double,double,double,double,double,double,double,int,double[],double[],double[],double[],double[],double[],double[],double,double[],double[],double[],double)",
   "bbintegrals(double,double,double,double,double,double,double,double,double)",
   "particles_init(double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double)",
   "bbdisk_comp(int,int,double,double,double,double,double,double,double,double,double,double,double)",
   "double = average_ene(int,int,double[],double[],double[])",
   "double = mcdjet1(double,double,double,double,double,double,double)",
   "b_prof(double,double,double,double,double,double,double,double,double,double,double,double,double)",
   "double = mcd_obs(double,double,double,double,double)",
   "MICompton(char,int,int,int,int,int,int,double,double,double,double,double[],gsl_spline_ptr,gsl_interp_accel_ptr,gsl_spline_ptr,gsl_interp_accel_ptr,double,double,double,double,double,double[],double[],double[],double[])",
   "jetpars(double,double,double,double,double,double,double,double,double,double,double,gsl_spline_ptr,gsl_interp_accel_ptr,double,double,double,double,double)",
   "aven(double,double,double)",
   "double = absfnc(double,void_ptr)",
   "double = comint(double,void_ptr)",
   "pa_rate(double,double,double)",
   "pl_and_th_comp(char,double,int,int,double,double[],double[],double,double,double,double,double,double,double,double,double,double,double,double,double[],double[],double[],double[],double)",
   "double = star(double,double,double,double,double,double,int)",
   "disk_init(int,double,double,double,double,double,double,double,int,double,double,double,double,double,double)",
   "seed_sync_and_disk_phtns(char,int,int,double,double,double,double,int,double,double,double,double,double,double,double[],double[],double[],double[],double[],double[],double,double)",
   "maxene(double,double,double,double,double,double,double,double,double,double,double,double,double)",
   "double = bbearth(double,void_ptr)",
   "annihilation(double,double,double,double,double,double,double)",
   "double = bbfnc(double,void_ptr)",
   "ene_arrays(char,int,int,int,int,double,double,int,double,double,double,double,double,double,double[],double[],double[],double[],double[],double[],double[])",
   "double = mcd_jet(double,double,double,double,double)",
   "double = bbdisk(double,double,double,double,double,double,double)",
   "vel_prof(double,double,double,double,double,double,gsl_spline_ptr,gsl_interp_accel_ptr,double,double)",
   ...
   "zonepars(int,int,int,double,double,double,double,double,double,double,double,double,double,int,double,double,double,double,double,double,double,double,double[])",
   "double = mcdobs1(double,double,double,double,double,double,double)",
   "jetgrid(int,int,int,double,double,double,double,double,double,double,int,double,double,double[])",
   "double = f_int(double,void_ptr)",
   "double = bbfnc3(double,void_ptr)",
   "create_plotFiles(int,int)",
   ...
   "double = fjet11(double,void_ptr)",
   "double = fjet1(double,void_ptr)",
   "double = K2(double)",
   "write_plotFiles(int,int,int,double,double,double,double,double,double,double,double,double,double,double,double,double)",
   "pproduction(int,double,double[],double[],double,double)",
   "jet_init(int,int,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double,double[],double[],double[],double[])",
   "double = enden(double,double)",
   "read_and_shift_eldists(int,int,double,double,double,double[],double[],double[],double[],double[],double[])",
   "double = bbdiskfnc(double,void_ptr)",
   "elnorm(int,double,double,double,double,double,double,double,double,double,double,double,double,double)",
   "double = mj(double,double)",
   "synchrotron(char,int,int,int,int,double,double,double,double,double,double,double,gsl_spline_ptr,gsl_interp_accel_ptr,gsl_spline_ptr,gsl_interp_accel_ptr,gsl_spline_ptr,gsl_interp_accel_ptr,double[],double[],double[],double[],double[])",
   "double = k1_fnc(double)",
   "electrons(int,int,double,double,double,double,double,double,double,double,double[],double[],double[],double[],double)",
   "double = comfnc(double,void_ptr)",
   "equipartition(double,double,int,double,double,double,double,double,double,double,double,double,double,double)",
   "double = bb(double,double)",
   "bbearthint(double,double,double,double,double,double,double,double)",
   "double = synemis(double,void_ptr)",
   "double = mjed(double,double)",
   "bhjet(double[],int,double[],double[],double[])",
   ...
   "ucompton(int,int,int,int,double,double,double[],double[],double[],double)",
...
static SLang_IConstant_Type agnjet_IConsts [] =	/* {{{ */
{
...
static SLang_DConstant_Type agnjet_DConsts [] =	/* {{{ */
{
...
typedef struct _Overloaded_Func {	/* {{{ */
   void (*func) (void);
   char *signature;
   int nargs;
   int min_nargs;
...
static Overloaded_Func Dispatch_Table[] =/* {{{ */
{
   { sl_enden_dd, (char*)"dd", 2, 2 },
   { sl_enden_dd, (char*)"dd", 2, 0 },
   { NULL, NULL, 0, 0}
};   /* }}} */
...
SLANG_MODULE(agnjet);
int init_agnjet_module_ns(char *ns_name)	/* {{{ */
{
   ...
   if (allocate_agnjet_opaque_types() == -1) return -1;

#ifdef HAVE_OPAQUE_IVARS
   if (-1 == set_opaque_ivar_types(agnjet_Opaque_IVars) ||
       -1 == SLns_add_intrin_var_table(ns,agnjet_Opaque_IVars,NULL))
	return -1;
#endif

   if ( -1 == SLns_add_iconstant_table(ns,agnjet_IConsts,NULL) ||
	-1 == SLns_add_dconstant_table(ns,agnjet_DConsts,NULL) ||
	-1 == SLns_add_intrin_fun_table (ns,agnjet_Funcs,(char*)"__agnjet__"))
	return -1;
