...
#pks1424x = (pks1424.T[0]+pks1424.T[1])/(2.*kevconv)
#pks1424xerrm = (pks1424x-pks1424.T[0])/kevconv
#pks1424xerrp = (pks1424.T[1]-pks1424x)/kevconv
...
ax2.set_ylabel('Flux density (mJy)',fontsize=18)
...
if(plotcheck>=2):
	#plt.figure(2)
	fig2, (ax3, ax4) = plt.subplots(1,2,figsize=(23,6))	
	...
	bar2 = fig2.colorbar(sm2,pad=0.10,ax=[ax3,ax4],ticks=[0.01,0.25,0.5,.75,0.99])  
