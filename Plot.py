...
if (fluxconv !=1):
    ax1.set_ylabel('Luminosity (erg/s)',fontsize=22)
else:
    ax1.set_ylabel('Flux (erg/s/cm^2)',fontsize=22)
...
ax2.set_ylabel('Flux density (mJy)',fontsize=22)
...
if(plotcheck>=2):#We create the colorbar:
    ...
    bar.set_label('$log_{10}(z)\,(r_g$)', fontsize=22)
...
if(plotcheck>=2):
    ...
    bar2.set_label('$log_{10}(z)\,(r_g$)', fontsize=22)
