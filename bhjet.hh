...
#include "lib/Cyclosyn.hpp"
#include "lib/Compton.hpp"
#include "lib/BBody.hpp"
...
typedef struct jet_enpars{
	...
	double sigf;			//final magnetization; values of sigma only used for magnetic acceleration
} jet_enpars;
